...
export const generateUserDocument = async (user, additionalData) => {
  ...
  if (!snapshot.exists) {
    var { email, photoURL } = user;
    if(photoURL == null) photoURL="https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcSYuIRmLMgwJRhONvJimSmKhV23zgXYSqy_7g_PZ3n1QyYF4iqw&usqp=CAU";
    try {
      await userRef.set({
        email,
        photoURL,

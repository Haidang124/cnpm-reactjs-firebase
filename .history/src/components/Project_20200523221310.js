          ...
          <div class="col-4">
            <div class="card shadow mb-4">
              <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">Planned ssssssssssssssssssssssssssssssssssss</h6>
              </div>
...
{/* 
          ...
          <div class="col-4">
            <div class="card shadow mb-4">
              <div class="card-header py-3">
                ...
                In Progress sssssssssssssssssssssssssssssssssssssssssssss
                </h6>
              </div>
              <div class="card-body"></div>
            </div>
          ...
          <div class="col-4">
            <div class="card shadow mb-4">
              <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">
                  Complete ssssssssssssssssssssssssssssssssssss
                </h6>
              </div>
              <div class="card-body"></div>
            </div>

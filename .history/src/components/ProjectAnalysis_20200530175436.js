              ...
              <div class="card shadow mb-4">
                ...
                <div class="card-body">
                  <div class="chart-pie pt-4 pb-2">
                    <ChartPie name="pie" data={this.state.chartDataPie} completeTask={this.state.completeTask.length} chartDataPie={this.state.chartDataPie} plannedTask={this.state.plannedTask.length} allTask={this.state.allTask.length} processTask={this.state.processTask.length}/>
                    {/* <Pie

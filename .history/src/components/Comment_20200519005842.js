        ...
        <div className="container-comment">
          ...
          <div className="numberComment-icon">
            ...
            <div className="numberLikeComment">
              ...
              <Link className="numberComment" onClick={this.findPost}>{this.state.currentPost.comment.length != 0 ? this.state.currentPost.comment.length :{this.state.}} Bình luận</Link>
            </div>
          </div>
          <div className="comment-comment">
            <input

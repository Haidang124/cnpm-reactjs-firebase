...
class Member extends Component {
  ...
  componentDidMount() {
    db.collection("topics")
      ...
      .onSnapshot((doc) => {
        if (typeof doc.data().topic[this.props.match.params.indexTopic] !== "undefined") {
          this.setState({
            members: doc.data().topic[this.props.match.params.indexTopic].member,
            nameTopic: doc.data().topic[this.props.match.params.indexTopic].name,
          });indexTopic
        }
      });
  }
  render() {
    // console.log(this.props.match.params.code +"  " +this.props.match.params.key)
    return (

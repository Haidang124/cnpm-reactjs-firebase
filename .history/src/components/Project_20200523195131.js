    ...
    render() {
        return (
            ...
            <div className="container-project">
              ...
              <ProjectDetail statusText ="In Progress" status="status-active" percent="60%"/>
              <ProjectDetail statusText ="Complete" status="status-complete" percent=/>
              <ProjectDetail statusText ="Planned" status="status-planned"/>

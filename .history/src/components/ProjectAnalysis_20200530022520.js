              ...
              <div class="card shadow mb-4">
                ...
                <div class="card-body">
                  <div class="chart-pie pt-4 pb-2">
                    <ChartPie name="pie" completeTask={this.state.plannedTask.length} plannedTask={this.state.plannedTask.length} allTask={this.state.allTask.length} processTask={this.state.processTask.length}/>
                  </div>

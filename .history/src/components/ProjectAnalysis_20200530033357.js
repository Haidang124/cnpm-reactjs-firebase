      ...
      .onSnapshot((doc) => {
        if (typeof doc.data().topic[this.props.match.params.key] !== "undefined") {
          ...
          this.setState({
            ...
            data:[doc.data().topic[this.props.match.params.key].planTaskProject.length, doc.data().topic[this.props.match.params.key].planTaskProject.length, doc.data().topic[this.props.match.params.key].planTaskProject.length]
            // chartDataPie: {
            //   datasets: [
            //     {
            //       label: "Population",

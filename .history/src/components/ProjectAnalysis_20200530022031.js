      ...
      .onSnapshot((doc) => {
        if (typeof doc.data().topic[this.props.match.params.key] !== "undefined") {
          this.setState({
            ...
            plannedTask: doc.data().topic[this.props.match.params.key].completeTaskProject,
            processTask: doc.data().topic[this.props.match.params.key].completeTaskProject,
              ...
              <div class="card shadow mb-4">
                ...
                <div class="card-body">
                  <div class="chart-pie pt-4 pb-2">
                    <ChartPie name="pie" completeTask={this.state.completeTask.length}  allTask={this.state.allTask.length}/>
                  </div>

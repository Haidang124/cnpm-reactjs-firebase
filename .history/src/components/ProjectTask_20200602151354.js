...
class ProjectTask extends Component {
  ...
  addTaskProject = () => {
    ...
    var valueExecutor = executor.options[executor.selectedIndex].value[0];
    var photoURL = executor.options[executor.selectedIndex].value[1];
                  ...
                  <th>
                    <select className="input-modal" id="executor-task">
                      ...
                      {this.state.member.map((item, key) => (
                        <option value={item.uidUser,item.photoURL} >{item.user}</option>
                      ))}
                    </select>
                  </th>
                  <th>

    ...
    return (
      <div className="project-anlysis">
        ...
        <div className="my-navbar">
              ...
              <div class="card shadow mb-4">
                ...
                <div class="card-body">
                  <div class="chart-pie pt-4 pb-2">
                    <ChartPie name="pie" data={[1,4,6]} completeTask={this.state.completeTask.length} chartDataPie={this.state.chartDataPie} plannedTask={this.state.plannedTask.length} allTask={this.state.allTask.length} processTask={this.state.processTask.length}/>
                  </div>
          ...
          <Button color="primary ml-4" onClick={this.setData}>Tìm Kiếm</Button>
        </div>
      </div>
    );
  }

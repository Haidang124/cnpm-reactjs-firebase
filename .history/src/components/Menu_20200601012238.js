      ...
      <div>
        <div className="container-left">
          <div className="left-top">
            <img
            src ={store.getState().userProfile ? this.state.photoURL :"https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcSYuIRmLMgwJRhONvJimSmKhV23zgXYSqy_7g_PZ3n1QyYF4iqw&usqp=CAU"}

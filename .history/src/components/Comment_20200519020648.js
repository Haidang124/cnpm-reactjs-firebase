  ...
  render() {
    return (
      <div className="Comment-comment">
        <div className="container-comment">
          ...
          <div className="numberComment-icon">
            <div>
              ...
              <i className="far fa-edit" title="Edit" onClick={this.openModal}></i>
              <i
        ...
        <Modal isOpen={this.state.isOpenModal} className="modal-edit-comment">
          <ModalHeader>Sửa bài viêt</ModalHeader>
          <ModalBody>
              Helo
          </ModalBody>
          <ModalFooter>

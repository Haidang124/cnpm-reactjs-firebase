...
class ProjectTask extends Component {
  ...
  startTaskNow = () => {
    ...
    var keyTask = this.state.fulldataTopic[this.state.indexTopic]
      ...
      //     this.state.mytasks[key].valuestatus = "Process";
      //   }
      // });
      // var newdatatask = {
      //   mytasks: this.state.mytasks,
      // };
      // db.collection("users").doc(store.getState().userAuth.uid).update(newdatatask);
  ...
  completeTaskNow = () => {
    ...
    // this.state.mytasks.map((item, key) => {
    //   if (item.keyTask == keyTask) {
    //     this.state.mytasks[key].valuestatus = "Complete";
    //   }
    // });
    // var newdatatask = {
    //   mytasks: this.state.mytasks,

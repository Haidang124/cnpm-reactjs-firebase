...
class UserComment extends Component {
  ...
  componentDidMount() {
    alert(this.props.codeCourse)
    db.collection("courses")
     .doc(this.props.codeCourse)
     .onSnapshot((doc) => {
       doc.data().post[this.props.indexPost].comment.map((item, key) => {
         if (item.keyComment == this.props.keyComment) {
           this.setState({
             currentComment: doc.data().post[this.props.indexPost].comment[key],
             fullDataComment: doc.data().post[this.props.indexPost].comment,
           });
         }
       });
     });

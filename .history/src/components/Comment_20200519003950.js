      ...
      this.state.fullPost.map((item, key) => {
        if (item.keyPost == this.props.keyPost) {
          this.setState({
            ...
            numberComment:this.state.fullPost[key].comment.length,
            ishideComment: false,
            indexPost: key,
          });
        }
            ...
            <div className="numberLikeComment">
              ...
              <Link className="numberComment" onClick={this.findPost}>
                {/* {this.state.currentPost.comment
                  ? this.state.currentPost.comment.length
                  : 0} */}
                  {this.setState.numberComment != -1 ? this.state.currentPost.comment.length
                  : 0}
                  {" "}
                Bình luận
              </Link>

...
class Profile extends Component {
  ...
  saveProfile=()=>{
    var msvNew =document.getElementById("file-avatar").value;
    var emailNew =document.getElementById("file-avatar").value;
    var firstNew =document.getElementById("file-avatar").value;
    var lastNew =document.getElementById("file-avatar").value;

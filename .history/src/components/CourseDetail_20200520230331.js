...
class CourseDetail extends Component {
  ...
  addTopic = () => {
    ...
    var number =document.getElementById("name-topic").value;
    var creator =document.getElementById("name-topic").value;
    var time =document.getElementById("name-topic").value;
  };
  ...
  componentDidMount() {
    ...
    var docRef = db.collection("topics").doc("topic");
    docRef
      .get()
      .then((doc) => {
        if (doc.exists) {
          if (typeof doc.data()[this.props.match.params.code] !== "undefined") {
            this.setState({
              topic: doc.data()[this.props.match.params.code],
            });
          }
        } else {
          console.log("No such document!");

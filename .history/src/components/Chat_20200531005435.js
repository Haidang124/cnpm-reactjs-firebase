...
class Chat extends Component {
  ...
  <div className="list-chat">
    <div className="info-user-chat">
      <img src="https://randomuser.me/api/portraits/men/44.jpg" className="avatar-chat" alt="" />
      <span>Mike Ross</span>
    </div>
  ...
  <div className="content-chat">
    ...
    <div className="list-content-chat">
      <div className="info-current">
        <img src="https://randomuser.me/api/portraits/men/44.jpg" className="avatar-chat" alt="" />
        <span>How the hell am i supposed to get a jury to believe you when i am not even sure that i do ?!</span>
      </div>

...
class ProjectTask extends Component {
  ...
  addTaskProject = () => {
    ...
    var photoURL = executor.options[executor.selectedIndex].getAttribute('photoURL');;
    ...
    if (
      ...
      if(valueExecutor == store.getState().userAuth.uid)
      {
          this.state.mytasks.photoURL
      }
    ...
    return (
      <div className="project-task">
                ...
                <div className="project-detail">
                  ...
                  <div className="worker-task">
                    <img
                      ...
                      src={item.photoURL ? item.photoURL :"https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcSYuIRmLMgwJRhONvJimSmKhV23zgXYSqy_7g_PZ3n1QyYF4iqw&usqp=CAU"}
                      className="avatar"
                    />
                  ...
                  <th>
                    <select className="input-modal" id="executor-task">
                      ...
                      {this.state.member.map((item, key) => (
                        <option value={item.uidUser} photoURL={item.photoURL} >{item.user}</option>
                      ))}
                    </select>
                  </th>
                  <th>
        ...
        <Modal isOpen={this.state.isStartModal}>
          ...
          <ModalFooter>
            <Button color="primary" onClick={this.startTaskNow}>Start Now</Button>

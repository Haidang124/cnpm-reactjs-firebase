      ...
      <div className="chat">
        ...
        <div >
          ...
          <div className="content-chat">
            ...
            {this.state.fulldataTopics[this.state.codeCourse].topic ? this.state.fulldataTopics[this.state.codeCourse].topic.map((item,key)=>item.keyTopic == this.state. ?   <div className="info-current">
                <img
                  src="https://randomuser.me/api/portraits/men/44.jpg"
                  className="avatar-chat"
                  alt=""

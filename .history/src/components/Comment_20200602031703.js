      ...
      <div className="Comment-comment">
        <div className="container-comment">
          <div className="info-comment">
            <div className="logo">
              <img
                 src ={this.props.photoURL ? store.getState().userProfile.photoURL :"https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcSYuIRmLMgwJRhONvJimSmKhV23zgXYSqy_7g_PZ3n1QyYF4iqw&usqp=CAU"}
          ...
          <div className="numberComment-icon">
            <div>
              ...
              <i
                ...
                title="Remove"
                onClick={() =>
                  this.props.removePost(this.props.keyPost, this.props.uidUser)
                }
              ></i>
            </div>
        ...
        <Modal isOpen={this.state.isOpenModal} className="modal-edit-post">
          ...
          <ModalFooter>
            <Button color="primary" onClick={() =>
                  {this.props.editPost(this.props.keyPost, this.props.uidUser);this.openModal()}
                }>Save changes</Button>

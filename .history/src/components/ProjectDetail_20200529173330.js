    ...
    db.collection("topics")
      ...
      .onSnapshot((doc) => {
       doc.data().topic.map((item,key)=>{
         ...
         {
          this.setState({
            process: doc.data().topic[key].completeTaskProject.length
            // process: doc.data().topic[key].completeTaskProject.length / doc.data().topic[key].alltaskProject.length
          });
         }
       })
      });
      ...
      <div className="project-detail">
        ...
        <div className="process-project-detail">
          <div
            ...
            style={{ width: Math.ceil(this.state.process)+ "px" }}
          >
            {Math.ceil(this.state.process)}%
          </div>
        </div>

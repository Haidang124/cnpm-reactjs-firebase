...
class Profile extends Component {
 ...
 handleUpload =()=>{
   var uploadTask = storage.ref(`images/${this.state.avatar.name}`).put(this.state.avatar);
   uploadTask.on(
     "state-changed",
     snapshot=>{},
     error => {
                  ...
                  <div className="author">
                    <a href="#">
                      <img
                        ...
                        src ={this.state.photoURL ? this.state.photoURL :"https://randomuser.me/api/portraits/men/41.jpg"}

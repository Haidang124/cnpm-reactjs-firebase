                            ...
                            <div className="info-current-friend">
                              ...
                              <img
                                ...
                                src ={ this.state.fulldataTopics[
                                  this.state.codeCourse
                                ].topic[key].Chat[keyChat].contentChat ?  this.state.fulldataTopics[
                                  this.state.codeCourse
                                ].topic[key].Chat[keyChat].contentChat :"https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcSYuIRmLMgwJRhONvJimSmKhV23zgXYSqy_7g_PZ3n1QyYF4iqw&usqp=CAU"}
                                className="avatar-chat"
                                alt=""
                              />
                            </div>

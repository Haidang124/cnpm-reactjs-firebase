    ...
    .onSnapshot((doc) =>{
        ...
        if (item.keyPost == this.props.keyPost) {
          this.setState({
            ...
            numberComment:doc.data().post[key].comment.length,
          });
          alert(doc.data().post[key].comment.length)
        }
      });
    });
  }
        ...
        <div className="container-comment">
          ...
          <div className="numberComment-icon">
            ...
            <div className="numberLikeComment">
              ...
              <Link className="numberComment" onClick={this.findPost}>{this.state.numberComment != 0 ?this.state.currentPost.comment.length :0} Bình luận</Link>
            </div>
          </div>
          <div className="comment-comment">
            <input
